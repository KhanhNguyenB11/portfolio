      ...
      <div className="h-[600vh] relative" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
          <motion.div style={{ x }} className="flex">
            <div className="h-screen w-screen flex justify-center bg-gradient-to-r from-purple-300 to-red-400"></div>
            {items.map((item) => (
              <div
                className={`h-screen w-screen flex justify-center bg-gradient-to-r ${item.color}`}
                key={item.id}
              >
